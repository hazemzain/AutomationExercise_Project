...
Automated tests using Selenium with Java for an E-commerce website called Automation Exercise.
 ...
 The project was created to practice test automation skills using the Selenium (Java) framework.
 The website under test is a website specifically designed for automated testing. The project contains a total of 21 automated tests, created based on test cases defined by the site's developers. 
